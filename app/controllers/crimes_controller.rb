class CrimesController < ApplicationController
	...
	def index
		...
		@community_grouped = Crime.select("community_areas.description", "count(0) as qnt").joins(:CommunityArea).group("community_areas.description").order("count(0) desc")
	...
	def communityfilter
		...
		@community_areas = CommunityArea.all
	...
	def communityfilterapply
		...
		@communityarea_desc = @id_source != "0" ? CommunityArea.find(@id_source) : "All"


		scope = Crime.select("community_areas.description", "count(0) as qnt").joins(:CommunityArea).group("community_areas.description").order("count(0) desc")
